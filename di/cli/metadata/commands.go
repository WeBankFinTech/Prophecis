	...
	Commands = []*commandMetadata{
			...
			PluginFlags: []plugin.Flag{
				{
					Name:        "m",
					HasValue:    false,
					Description: "monitoring the job",
				},
			},
			CliFlags: []cli.Flag{
				cli.BoolTFlag{
					Name:  "m",
					Usage: "monitoring the job",
				},
			},
		},
		{
		...
		},
		{
			...
			PluginFlags: []plugin.Flag{
				...
				{
					Name:        "page",
					Description: "page of job list.",
				},
				{
					Name:        "size",
					Description: "size of job list.",
				},
			},
			CliFlags: []cli.Flag{
				cli.StringFlag{
				...
				cli.StringFlag{
					Name:  "namespace",
					Usage: "job's namespace.",
				},
				cli.StringFlag{
					Name:  "page",
					Usage: "page of job list.",
				},
				cli.StringFlag{
					Name:  "size",
					Usage: "size of job list.",
				},
			},
		},
		{
