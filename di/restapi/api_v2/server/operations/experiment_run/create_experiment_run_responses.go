...
func (o *CreateExperimentRunOK) WithPayload(payload *restmodels.CreateExperimentRunResponse) *CreateExperimentRunOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the create experiment run o k response
func (o *CreateExperimentRunOK) SetPayload(payload *restmodels.CreateExperimentRunResponse) {
	o.Payload = payload
}
