...
type ListExperimentRunsOK struct {
	...
	/*
	  In: Body
	*/
	Payload *restmodels.ListExperimentRunsResponse `json:"body,omitempty"`
}
...
func (o *ListExperimentRunsOK) WithPayload(payload *restmodels.ListExperimentRunsResponse) *ListExperimentRunsOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list experiment runs o k response
func (o *ListExperimentRunsOK) SetPayload(payload *restmodels.ListExperimentRunsResponse) {
	o.Payload = payload
}
...
/*ListExperimentRunsNotFound Model create failed
