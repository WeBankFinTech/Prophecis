...
// WithExperiment adds the experiment to the create experiment params
func (o *CreateExperimentParams) WithExperiment(experiment *restmodels.ProphecisExperimentRequest) *CreateExperimentParams {
	o.SetExperiment(experiment)
	return o
}

// SetExperiment adds the experiment to the create experiment params
func (o *CreateExperimentParams) SetExperiment(experiment *restmodels.ProphecisExperimentRequest) {
