...
type CopyExperimentOK struct {
	...
	/*
	  In: Body
	*/
	Payload *restmodels.ProphecisExperimentRequest `json:"body,omitempty"`
}
...
func (o *CopyExperimentOK) WithPayload(payload *restmodels.ProphecisExperimentRequest) *CopyExperimentOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the copy experiment o k response
func (o *CopyExperimentOK) SetPayload(payload *restmodels.ProphecisExperimentRequest) {
	o.Payload = payload
}
