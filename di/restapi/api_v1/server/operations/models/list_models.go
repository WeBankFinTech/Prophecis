...
type ListModelsHandlerFunc func(ListModelsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ListModelsHandlerFunc) Handle(params ListModelsParams) middleware.Responder {
	return fn(params)
}

// ListModelsHandler interface for that can handle valid list models params
type ListModelsHandler interface {
	Handle(ListModelsParams) middleware.Responder
}
...
/*ListModels swagger:route GET /di/v1/models Models listModels
