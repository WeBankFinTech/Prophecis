...
func (t splitTraining) jobSpecForLearner(service *v1core.Service) (*v1.Job, error) {
	...
	learnerContainer := newConstructLearnerContainer(t.req, learnerDefn.envVars, learnerDefn.volumeMounts, learnerDefn.mountTrainingDataStoreInLearner, learnerDefn.mountResultsStoreInLearner, t.logr) // nil for mounting shared NFS volume since non split mode
