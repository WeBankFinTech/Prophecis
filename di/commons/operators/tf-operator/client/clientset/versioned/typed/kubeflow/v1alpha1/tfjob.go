...
import (
	...
	v1alpha1 "webank/DI/commons/operators/tf-operator/apis/tensorflow/v1alpha1"
	scheme "webank/DI/commons/operators/tf-operator/client/clientset/versioned/scheme"
)
