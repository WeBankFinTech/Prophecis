...
func FileInfoFindGood() string {
	...
	// stack[1]: /home/sboag/git/src/webank/DI/commons/logger/logger.go:72
	// stack[2]: /home/sboag/git/src/webank/DI/commons/logger/logger.go:120
	// stack[3]: /home/sboag/git/src/webank/DI/commons/logger/logger.go:136
	// stack[4]: /home/sboag/git/src/webank/DI/commons/service/lcm/service_impl.go:656
...
func GetLogger() *LocLoggingEntry {
	logger := new(LocLoggingEntry)

	//data := logger.NewDlaaSLogData(logger.LogkeyRestAPIService)
	//data[logger.LogkeyNamespace] = params.HTTPRequest.Header.Get("X-DLaaS-UserID")
	logr := &log.Entry{Logger: log.StandardLogger()}
	logger.Logger = logr
	logger.Enabled = true
