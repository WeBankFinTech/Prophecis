...
func (m *Result) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *Result) validateModel(formats strfmt.Registry) error {
...
func (m *Result) validateUpdateTimestamp(formats strfmt.Registry) error {
