...
// AddUserToGroupParams contains all the bound params for the add user to group operation
...
//
// To ensure default values, the struct must have been initialized with NewAddUserToGroupParams() beforehand.
func (o *AddUserToGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
