...
// AddNamespaceParams contains all the bound params for the add namespace operation
...
//
// To ensure default values, the struct must have been initialized with NewAddNamespaceParams() beforehand.
func (o *AddNamespaceParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
