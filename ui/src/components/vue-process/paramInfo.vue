      ...
      <div v-for="(item, index) in arr"
        ...
        <label class="half">
          ...
          <input v-model="item.key"
            :placeholder="t('vue-process.attribute name')">
        </label>
        <label class="half">
          <input v-model="item.value"
            :placeholder="t('vue-process.property value')">
        </label>
      </div>
      <div class="row">
        <button class="designer-button row-button"
          @click="save">
          {{ t('vue-process.save') }}
        </button>
      </div>
