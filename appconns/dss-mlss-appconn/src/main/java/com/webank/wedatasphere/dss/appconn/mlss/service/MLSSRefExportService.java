...
import com.webank.wedatasphere.dss.appconn.mlss.operation.MLSSRefExportOperation;
...
public class MLSSRefExportService extends AbstractRefExportService {

    @Override
    public RefExportOperation createRefExportOperation() {
        return new MLSSRefExportOperation(this);
    }
