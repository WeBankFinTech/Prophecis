...
import com.webank.wedatasphere.dss.appconn.mlflow.execution.MLFlowExecutionService;
...
public class MLFlowDevelopmentIntegrationStandard extends OnlyExecutionDevelopmentStandard {

    private static final Logger LOGGER = LoggerFactory.getLogger(MLFlowDevelopmentIntegrationStandard.class);

    @Override
    protected RefExecutionService createRefExecutionService() {
        return  new MLFlowExecutionService();
    }
